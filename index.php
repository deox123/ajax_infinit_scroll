...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      // We cant use innerHTML b/c it will replace previus blog posts with the new ones
      function appendToDiv(div, new_html) {
        // Put the new HTML into a temp div
        // This causes browser to parse it as elements, not as text
        var temp = document.createElement('div');
        temp.innerHTML = new_html;

        // Then we can find and work with those elements.
        // Use firstElementChild b/c of how DOM treats whitespace.
        // **This way all blog posts are in the same div and every blog post has his own div**
